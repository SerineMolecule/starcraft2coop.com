...
<?= startHead() ?>
  ...
  <?= startContent() ?>
    ...
    <?php include("../../html/scripts/reporterror.php"); ?>
    <div id="links">
    ...
    <form action="#">
        (There are a total of <?php echo(count(scandir("../../html/images/commanderportraits")) - 2); ?> commanders currently)
        <br>
        <table id="calcTable">
            <thead>
                <tr>
    ...
    <script>
        ...
        $("#calc").on("click", function(event){
            ...
            bestLevel = calcLevelFromExp(totalExp - <?= count(scandir("../../html/images/commanderportraits")) - 2 ?> * (1045000*4));
