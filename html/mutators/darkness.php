...
?>
<?= startHead() ?>
    <title>Starcraft 2 Co-op - Mutator - Darkness</title>
    <link rel="canonical" href="https://starcraft2coop.com/mutators/darkness">
<?= startContent() ?>
    <h1>Mutator: Darkness</h1>
    <p><img src="/images/mutators/darkness.png" alt="" /></p>
    <p>Previously explored areas remain blacked out on the minimap while outside of player vision.</p>
    <table>
