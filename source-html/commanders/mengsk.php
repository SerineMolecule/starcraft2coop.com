...
<?= startHead() ?>
  ...
  <?= startContent() ?>
    ...
    <p>Mengsk can send multiple Laborers to build a structure. Each Laborer after the first builds at 60% the speed of the first Laborer. The time taken to complete a structure based on the number of Laborers building is as follows:</p>
    <table>
        <thead>
            <tr>
                <th>Laborers</th>
