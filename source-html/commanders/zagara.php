...
<?= startHead() ?>
  ...
  <?= startContent() ?>
    ...
    <h1 data-toc-target="header"><span class="unbold">Commander:</span> Zagara</h1>
    <p id="commanderMotto">Swarm Broodmother</p>
    <?php include("../../includes/reporterror.php");?>
    <div id="links">
        <h2>Sections on this Page</h2>
        <p><a href="#header">Commander: Zagara</a></p>
        ...
        <p class="toc-subsection"><a href="#bile-launchers">Bile Launchers</a></p>
    ...
    <p>None</p>
    <h3 id="bile-launchers">Bile Launchers</h3>
