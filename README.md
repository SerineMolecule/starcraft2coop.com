...
If you edit the data files in `/data`, you'll need to run `./data/build` to rebuild them into `/public_html/data`. If you want to change the format of the data files, you'll need to update the types in `/data/data-types.ts` and run `./data/build` to build them.
